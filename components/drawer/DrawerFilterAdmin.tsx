...
import "./style.scss";
import { FILTER_ACCOUNT } from "@/src/constants/filter";
...
const DrawerFilterAdmin = ({
  ...
  return (
    ...
    >
      ...
      <div>
        {FILTER_ACCOUNT.map((filterItem, index) => (
            ...
            <AccordionItem value={`item-${index}`} className="border-none">
              ...
              <AccordionContent className="pt-1 text-neutral-700">
                {filterItem.options.map((option, optionIndex) => (
                  <label key={optionIndex} className="flex items-center mb-1 cursor-pointer">
                    <input
                      type="checkbox"
