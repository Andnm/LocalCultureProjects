              ...
              {userLogin?.role_name !== "Lecturer" && (
                <div className="mt-5 flex">
                  ...
                  <span className="ml-3 hidden sm:block">
                    ...
                    >
                      <div className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none hover:scale-105 transition-all focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50">
                        <svg
                          className="-ml-1 mr-2 h-5 w-5 text-gray-400"
