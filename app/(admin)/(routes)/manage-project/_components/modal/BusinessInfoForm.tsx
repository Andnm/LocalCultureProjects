...
const BusinessInfoForm: React.FC<BusinessInfoFormProps> = ({
  ...
  <div className="grid grid-cols-3 px-4 ">
    ...
    <Form.Item label="Lĩnh vực kinh doanh" className="mx-3">
      <Select disabled={!editMode} value={businessUser?.business_sector}>
    ...
    <Form.Item label="Mô tả doanh nghiệp" className="mx-3">
      <TextArea rows={4} disabled={!editMode} value={businessUser?.description} />
    </Form.Item>
    ...
    <Form.Item label="Địa chỉ cụ thể" className="mx-3">
      <Input disabled={!editMode} value={businessUser?.address_detail} />
    </Form.Item>
  </div>
);
